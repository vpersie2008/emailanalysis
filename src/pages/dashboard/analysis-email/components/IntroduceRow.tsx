  ...
  <Row gutter={24}>
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        title={
          <FormattedMessage
            id="dashboardemailanalysis.analysis.total-sales"
        ...
        footer={
          <Field
            label={
              <FormattedMessage
                id="dashboardemailanalysis.analysis.day-sales"
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        loading={loading}
        title={
          <FormattedMessage id="dashboardemailanalysis.analysis.visits" defaultMessage="Visits" />
        }
        action={
          <Tooltip
            title={
        ...
        footer={
          <Field
            label={
              <FormattedMessage
                id="dashboardemailanalysis.analysis.day-visits"
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        loading={loading}
        title={
          <FormattedMessage id="dashboardemailanalysis.analysis.payments" defaultMessage="Payments" />
        }
        action={
          <Tooltip
            title={
        ...
        footer={
          <Field
            label={
              <FormattedMessage
                id="dashboardemailanalysis.analysis.conversion-rate"
